...
A comprehensive MCP server providing 72 tools for managing Proxmox Virtual Environment, including QEMU VMs and LXC containers.
...
- All 72 tool descriptions exposed via MCP `ListTools`
- Rate limiter middleware included
- Pino structured logging instead of `console.log`

## Features

- **72 comprehensive tools** for Proxmox management
...
This server provides **72 comprehensive tools** for Proxmox management:
